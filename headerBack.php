...
<head>
    ...
    <link rel="stylesheet" href="Back/assets/vendor/font-awesome/css/all.min.css">
    <link rel="stylesheet" href="Back/assets/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css">
    <link rel="stylesheet" href="Back/assets/css/nice-select.css">
    <link rel="stylesheet" href="Back/assets/css/jquery-ui.min.css">
    <!-- Theme Styles -->
    <link rel="stylesheet" href="Back/assets/css/theme.css">
...
<body>
    ...
    <header class="u-header">
        <div class="u-header-left">
            <a class="u-header-logo" href="index.html">
                <img class="u-logo-desktop" src="Back/assets/img/logo.png" width="160" alt="Stream Dashboard">
                <img class="img-fluid u-logo-mobile" src="Back/assets/img/logo-mobile.png" width="50" alt="Stream Dashboard">
            </a>
        </div>
        ...
        <div class="u-header-right">
            ...
            <div class="dropdown ml-2">
                <a class="link-muted d-flex align-items-center us-u-avatar-wrap" href="#!" role="button" id="dropdownMenuLink" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown">
                    <img class="u-avatar--xs img-fluid rounded-circle mr-2 bg-gradient" src="Back/assets/img/avatars/img1.png" alt="User Profile">
    ...
    <!-- Plugins -->
    <script src="Back/assets/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="Back/assets/vendor/chart.js/dist/Chart.min.js"></script>
    <script src="Back/assets/js/jquery.nice-select.min.js"></script>
    <script src="Back/assets/js/jquery-ui.min.js"></script>

    <!-- Initialization  -->
    <script src="Back/assets/js/sidebar-nav.js"></script>
    <script src="Back/assets/js/main.js"></script>
    <script src="Back/assets/js/dashboard-page-scripts.js"></script>